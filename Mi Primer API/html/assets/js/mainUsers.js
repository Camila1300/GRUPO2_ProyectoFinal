...
const url = 'https://localhost:5001/Usuario';
    ...
    users.forEach(user => {
        ...
        <img src="${user.phoneNumber}" class="card-img-top" alt="...">
            <div class="card-body" data-id=${user.id}>
                <h5 class="card-title" data-id=${user.nombreUsuario}>${user.nombreUsuario}</h5>
                <p class="card-text email">${user.correo}</p>
                <p class="card-text password d-none">${user.contraseña}</p>
